...
import "github.com/akhill4054/loom/internal/broker"

// Message returns an event encoded as compatible byte format.
func Message(action broker.Action, topic string, payload []byte) []byte {
	t := []byte(topic)
